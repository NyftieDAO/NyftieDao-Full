        ...
        <div className='row align-items-center'>
          ...
          <div className="col-lg-4 offset-lg-2 wow fadeIn" data-wow-delay=".5s">
            <div className="box-login text-center">
              ...
              <h3 className="mb10">Sign In with MetaMask</h3>
              <p>Login using an existing account or create a new account <NavLink to="/register">here</NavLink> .</p>
              <WalletButton />
              {/* <Button onClick={() => console.log(process.env)}>Log Env Variables</Button> */}
