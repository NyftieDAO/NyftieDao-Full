  ...
  <section className='container'>
        ...
        <Container>
          ...
          {/* <Row>
            ...
            <Col sm={2}>
              <Card className="nft__item">
                <a href='/m/MyGame'>/m/MyGame</a>
              </Card>
            </Col>
            <Col sm={2}>
              <Card className="nft__item">
                <a href='/m/posters'>/m/VRGame</a>
              </Card>
            </Col>
            <Col sm={2}>
              <Card className="nft__item">Test 4</Card>
            </Col>
            <Col sm={2}>
              <Card className="nft__item">Test 5</Card>
            </Col>
            <Col sm={2}>
              <Card className="nft__item">Test 6</Card>
            </Col>
          </Row> */}
          <h3>Live Gaming and NFT Market Presales </h3>
          <Row style={{paddingTop: '10px'}}>
            ...
            <Col sm={4}>
              <OfferingCard></OfferingCard>
              {/* <Card className="nft__item text-center">
                <a href='/imo/MetaverseArcade'>Metaverse Arcade</a>
              </Card> */}
            </Col>
          </Row>
        </Container>
